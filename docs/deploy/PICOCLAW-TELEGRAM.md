...
PicoClaw protected config/secret:

```dotenv
TELEGRAM_BOT_TOKEN=<BotFather-token-for-the-shared-bot>
MINDOIST_AGENT_TOKEN=<same-service-token-as-api>
MINDOIST_INTERNAL_URL=http://api:3000
<CLOUD_MODEL_PROVIDER_KEY>=<provider-secret>
```
