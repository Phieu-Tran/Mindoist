              ...
              <div className="flex flex-wrap items-center gap-1">
                ...
                <div ref={colorRef} className="relative shrink-0">
                  <button
                    ...
                    className={cn(
                      "task-color-swatch flex h-11 w-11 items-center justify-center rounded-full border border-border/60 transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring xl:h-7 xl:w-7",
                  ...
                  {colorOpen && (
                    ...
                    >
                      <button
                        ...
                        className="flex h-11 w-11 items-center justify-center rounded-full bg-muted text-[0.55rem] font-medium text-muted-foreground transition-transform hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring xl:h-7 xl:w-7"
                      >
                      ...
                      {TASK_COLOR_OPTIONS.map(option => (
                        <button
                          ...
                          className={cn(
                            'task-color-swatch flex h-11 w-11 items-center justify-center rounded-full transition-transform hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring xl:h-7 xl:w-7',
                ...
                <div ref={priorityRef} className="relative shrink-0">
                  <button
                    ...
                    className={cn(
                      'flex min-h-11 items-center gap-1.5 rounded-control border border-border/60 bg-background px-2 text-xs font-medium transition-colors hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring xl:min-h-7',
                  ...
                  {priorityOpen && (
                    ...
                    >
                      <button
                        ...
                        className={cn(
                          'flex min-h-11 w-full items-center rounded-control px-2 py-1.5 text-left text-xs transition-colors hover:bg-muted xl:min-h-8',
                      ...
                      {[1, 2, 3, 4].map(p => (
                        <button
                          ...
                          className={cn(
                            'flex min-h-11 w-full items-center gap-1.5 rounded-control px-2 py-1.5 text-left text-xs font-medium transition-colors hover:bg-muted xl:min-h-8',
                            priority === p && 'bg-muted'
                          )}
                        >
                ...
                {/* Project */}
                <div className="flex min-h-11 shrink-0 items-center gap-1 rounded-control border border-border/60 bg-background pl-1.5 xl:min-h-7">
                ...
                <div ref={tagsRef} className="relative shrink-0">
                  <button
                    ...
                    className={cn(
                      'flex min-h-11 max-w-[11rem] items-center gap-1.5 rounded-control border border-border/60 bg-background px-2 text-xs font-medium transition-colors hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring xl:min-h-7',
                        ...
                        tags.map(tag => {
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                'flex min-h-11 w-full items-center gap-1.5 rounded-control px-2 py-1.5 text-left text-xs transition-colors hover:bg-muted xl:min-h-8',
                ...
                >
                  <button
                    ...
                    className={cn(
                      "flex h-11 w-11 items-center justify-center rounded-control border border-input bg-background transition-colors hover:border-muted-foreground hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background xl:h-7 xl:w-7",
                ...
                {/* Duration */}
                <div className={cn(
                  "flex min-h-11 shrink-0 items-center gap-0.5 rounded-control border border-input bg-background px-1.5 transition-colors hover:border-muted-foreground focus-within:border-ring focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 focus-within:ring-offset-background xl:min-h-7",
                  featureFlags.taskDetailV2 && "hidden",
                )}>
              ...
              {recurrencePreset === 'custom' && (
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    ...
                    spellCheck={false}
                    className="h-11 flex-1 border-border/70 bg-background font-mono text-xs xl:h-7"
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <div className="flex gap-1">
                      <button
                        ...
                        className={cn(
                          'min-h-11 rounded-control px-2 py-0.5 text-xs transition-colors xl:min-h-7',
                ...
                >
                  ...
                  {editingSubtaskId === st.id ? (
                    <Input
                      ...
                      autoFocus
                      className="h-11 flex-1 border-border/70 bg-background text-sm xl:h-7"
                    />
                  ) : (
                    <button
                      type="button"
                  ...
                  <div className="flex shrink-0 items-center gap-0.5 opacity-0 transition-opacity group-hover:opacity-100">
                    <button
                      ...
                      className="flex h-11 w-11 items-center justify-center rounded-md text-muted-foreground hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring xl:h-7 xl:w-7"
                    >
                    ...
                    <button
                      ...
                      className="flex h-11 w-11 items-center justify-center rounded-md text-muted-foreground hover:bg-destructive/10 hover:text-destructive focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring xl:h-7 xl:w-7"
                    >
            ...
            <div className="flex flex-col gap-1.5 border-b border-border/70 py-1.5" data-testid="detail-reminders">
              ...
              <div className="flex flex-wrap items-center gap-1.5">
                ...
                <button
                  ...
                  className="flex min-h-11 items-center gap-1 rounded-full border border-dashed border-border/70 px-3 py-1 text-xs text-muted-foreground transition-colors hover:border-primary hover:text-primary xl:min-h-8"
                >
                ...
                {reminderMenuOpen && (
                  <div className="absolute left-0 top-full z-50 mt-1 w-52 rounded-panel border border-border bg-card shadow-lg py-1">
                    <button type="button" className="min-h-11 w-full px-3 py-1.5 text-left text-sm hover:bg-muted xl:min-h-8" onClick={() => handleAddReminder(5 * 60_000)}>
                      {t('detail.reminder5m')}
                    </button>
                    <button type="button" className="min-h-11 w-full px-3 py-1.5 text-left text-sm hover:bg-muted xl:min-h-8" onClick={() => handleAddReminder(15 * 60_000)}>
                      {t('detail.reminder15m')}
                    </button>
                    <button type="button" className="min-h-11 w-full px-3 py-1.5 text-left text-sm hover:bg-muted xl:min-h-8" onClick={() => handleAddReminder(30 * 60_000)}>
                      {t('detail.reminder30m')}
                    </button>
                    <button type="button" className="min-h-11 w-full px-3 py-1.5 text-left text-sm hover:bg-muted xl:min-h-8" onClick={() => handleAddReminder(60 * 60_000)}>
                      {t('detail.reminder1h')}
                    </button>
                    <button type="button" className="min-h-11 w-full px-3 py-1.5 text-left text-sm hover:bg-muted xl:min-h-8" onClick={() => handleAddReminder(24 * 60 * 60_000)}>
                      {t('detail.reminder1d')}
                    </button>
                    <div className="border-t border-border/50 px-3 py-1.5">
                      ...
                      <button
                        ...
                        className="mt-1 min-h-11 w-full rounded bg-primary px-2 py-1 text-xs text-primary-foreground hover:bg-primary/90 disabled:opacity-50 xl:min-h-8"
                      >
