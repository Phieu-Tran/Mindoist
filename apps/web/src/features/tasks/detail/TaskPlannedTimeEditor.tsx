...
export function TaskPlannedTimeEditor({ taskId, defaultDate, onChanged }: Props) {
  ...
  return (
    <section
      ...
      className="rounded-lg bg-background/75 px-2.5 py-2"
    >
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        {!loading && sortedBlocks.map(block => {
          ...
          return (
            <div
              key={block.id}
              className="group flex min-h-9 items-center rounded-control bg-muted/65 text-xs"
            >
              <button
                type="button"
              ...
              <button
                ...
                className="flex min-h-9 w-8 items-center justify-center rounded-r-control text-muted-foreground hover:bg-destructive/10 hover:text-destructive focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50"
              >
        ...
        {!loading && editingId !== 'new' && (
          <button
            type="button"
            onClick={beginCreate}
            className="flex min-h-9 items-center gap-1 rounded-control bg-muted/55 px-2 text-xs text-muted-foreground transition-colors hover:bg-muted hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
