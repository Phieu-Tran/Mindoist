...
describe('SettingsPage', () => {
  ...
  let onUpdateHiddenNavItems: ReturnType<typeof vi.fn>;
    ...
    return render(
      <I18nextProvider i18n={i18n}>
        <SettingsPage
          ...
          hiddenNavItems={[]}
          onUpdateHiddenNavItems={onUpdateHiddenNavItems}
  ...
  it('switches to the navigation panel and toggles a module', () => {
    renderPage();
    fireEvent.click(screen.getByTestId('settings-tab-navigation'));
    expect(screen.getByTestId('settings-panel-navigation')).toBeInTheDocument();
    fireEvent.click(screen.getByTestId('setting-nav-notes'));
    expect(onUpdateHiddenNavItems).toHaveBeenCalledWith(['notes']);
  });
