...
import { ObsidianSettingsCard } from './ObsidianSettingsCard';
...
export type SettingsCategory = 'account' | 'appearance' | 'integrations' | 'google' | 'data' | 'productivity' | 'about';
...
interface Props {
  ...
  onSaveObsidianSettings: (settings: ObsidianSettings) => void;
...
export function SettingsPage({
  ...
  obsidianSettings, onSaveObsidianSettings, initialCategory = 'account',
}: Props) {
      ...
      <div className="min-w-0 flex-1">
        ...
        {category === 'integrations' && (
          <div data-testid="settings-panel-integrations" className="flex flex-col gap-4">
            ...
            <ObsidianSettingsCard settings={obsidianSettings} onSave={onSaveObsidianSettings} />
            <TelegramConnectCard />
          </div>
        )}
